...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('plantree_category', 'creation_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 4, 15, 2, 14, 0, 603868), auto_now_add=True, blank=True), keep_default=False)

        # Adding field 'Category.finished_time'
        db.add_column('plantree_category', 'finished_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 4, 15, 2, 14, 8, 742599)), keep_default=False)
